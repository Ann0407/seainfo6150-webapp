...
const Article = () => {
  return (
    <div className={styles.container}>
      <div>
      <h1 className={styles.header}>The Statue of Liberty's torch heads to new museum</h1>
      <p>by Kate Farley (kate.farley@nytimes.com), November 22, 2018</p>
      </div>

      <h2>The Statue of Liberty's original torch is getting a new home.</h2>
      ...
      <ul>* Total overall height from the base of the pedestal foundation to the tip of the torch is 305 feet, 6 inches</ul>

      <ul>* Height of the Statue from her heel to the top of her head is 111 feet, 6 inches</ul>

      <ul>* The Statue has a 35-foot waistline</ul>

      <ul>* Total weight of the Statue of Liberty is 225 tons (or 450,000 pounds)</ul>
    </div>
  )
}
